...
public class DeathManager : MonoBehaviour
{
    ...
    {
        // Reset death screen state khi load scene mới
    ...
    public void ShowDeathScreen()
    {
        ...
        if (deathScreenUI != null)
        {
            ...
            if (canvasGroup != null)
            {
                ...
                fadeCoroutine = StartCoroutine(FadeInDeathScreen(canvasGroup));
            }
        }
        else
        {
    ...
    {
        if (canvasGroup == null || deathScreenUI == null) yield break;
        
        canvasGroup.alpha = 0f;
        float elapsedTime = 0f;
        
        while (elapsedTime < fadeInDuration && deathScreenUI != null && canvasGroup != null)
        {
